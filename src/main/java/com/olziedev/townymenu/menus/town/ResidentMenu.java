...
public class ResidentMenu extends PageMenu {
    ...
    public ResidentMenu(ConfigurationSection section, OlzieMenu olzieMenu) {
    ...
    public FrameworkMenu open(Player player, Function<String, String> function) {
        ...
        List<Resident> residents = !pageItems.isEmpty() ? Collections.emptyList() : town.getResidents();
        ...
        for (Resident resident : residents) {
            ...
            pageItems.add(new PageItem<>(() -> this.createItem(this.section.getConfigurationSection("resident-item"), x -> replaceFunction.apply(Collections.singletonList(x)).get(0), replaceFunction), (click, item) -> {
                ...
                ResidentEditMenu menu = this.menuManager.getMenu(ResidentEditMenu.class);
